...
def extra_body(extra_body: Mapping[str, Any]) -> Mapping[str, Any]:
    ...
    Args:
        extra_body (Mapping[str, Any]): The extra_body parameter to validate. It should be a dictionary-like object containing the following fields:
            - session_id (str): Session identifier, generated by you (can be related to the browser session, or some group method that you desire).
            - customer_id (str, optional): Customer identifier, sent by you (to identify your customer inferences, e.g., id, country codes, etc).
    ...
    Note:
        ...
        - The 'customer_id' field is optional. (It's recommended for usage).
        - The 'channel_id' field is optional. If not provided, it will be set to "LANGCHAIN_NEOSPACE".
        - You can include any additional fields you want to track in the 'extra_body' parameter inside your AI Ops.
    """
